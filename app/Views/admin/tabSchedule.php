<div class="tab-pane show" id="schedule" role="tabpanel">
    <div class="row">
        <div class="col-12">
            <div class="alert alert-custom alert-success" role="alert">
                ...
                <div class="alert-text">Configure su horario. ¡Puede utilizar el switch para asignar si un día es laborable o no! El sistema está diseñado para que pueda crear un horario de turno corrido o un horario de tuno partido configurable para cada día de la semana. Si usted quiere configurar turno corrido solo debe rellenar la información del primer turno, si, por el contrario, desea configurar un turno partido debe rellenar además el segundo turno. Tenga en cuenta usar un formato de 24 horas para asignar los valores.</div>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <h5 class="bg-secondary p-2">Lunes</h5>
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-monday_start1" class="form-control" value="<?php echo date('H:i', strtotime($config->monday_start1)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-monday_end1">Hora de Finalización</label>
                            <input type="text" id="txt-monday_end1" class="form-control" value="<?php echo date('H:i', strtotime($config->monday_end1)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-monday_start2" class="form-control" value="<?php echo date('H:i', strtotime($config->monday_start2)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-monday_end2">Hora de Finalización</label>
                            <input type="text" id="txt-monday_end2" class="form-control" value="<?php echo date('H:i', strtotime($config->monday_end2)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 mt-5">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <h5 class="bg-secondary p-2">Martes</h5>
            <div class="row">
                <div class="col-12 text-end">
                    <?php
                    $label = '';
                ...
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-tuesday_start1" class="form-control" value="<?php echo date('H:i', strtotime($config->tuesday_start1)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-tuesday_end1">Hora de Finalización</label>
                            <input type="text" id="txt-tuesday_end1" class="form-control" value="<?php echo date('H:i', strtotime($config->tuesday_end1)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-tuesday_start2" class="form-control" value="<?php echo date('H:i', strtotime($config->tuesday_start2)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-tuesday_end2">Hora de Finalización</label>
                            <input type="text" id="txt-tuesday_end2" class="form-control" value="<?php echo date('H:i', strtotime($config->tuesday_end2)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 mt-5">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <h5 class="bg-secondary p-2">Miércoles</h5>
            <div class="row">
                <div class="col-12 text-end">
                    <?php
                    $label = '';
                ...
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-wednesday_start1" class="form-control" value="<?php echo date('H:i', strtotime($config->wednesday_start1)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-wednesday_end1">Hora de Finalización</label>
                            <input type="text" id="txt-wednesday_end1" class="form-control" value="<?php echo date('H:i', strtotime($config->wednesday_end1)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-wednesday_start2" class="form-control" value="<?php echo date('H:i', strtotime($config->wednesday_start2)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-wednesday_end2">Hora de Finalización</label>
                            <input type="text" id="txt-wednesday_end2" class="form-control" value="<?php echo date('H:i', strtotime($config->wednesday_end2)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 mt-5">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <h5 class="bg-secondary p-2">Jueves</h5>
            <div class="row">
                <div class="col-12 text-end">
                    <?php
                    $label = '';
                ...
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-thursday_start1" class="form-control" value="<?php echo date('H:i', strtotime($config->thursday_start1)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-thursday_end1">Hora de Finalización</label>
                            <input type="text" id="txt-thursday_end1" class="form-control" value="<?php echo date('H:i', strtotime($config->thursday_end1)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-thursday_start2" class="form-control" value="<?php echo date('H:i', strtotime($config->thursday_start2)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-thursday_end2">Hora de Finalización</label>
                            <input type="text" id="txt-thursday_end2" class="form-control" value="<?php echo date('H:i', strtotime($config->thursday_end2)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 mt-5">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <h5 class="bg-secondary p-2">Viernes</h5>
            <div class="row">
                <div class="col-12 text-end">
                    <?php
                    $label = '';
                ...
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-friday_start1" class="form-control" value="<?php echo date('H:i', strtotime($config->friday_start1)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-friday_end1">Hora de Finalización</label>
                            <input type="text" id="txt-friday_end1" class="form-control" value="<?php echo date('H:i', strtotime($config->friday_end1)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-friday_start2" class="form-control" value="<?php echo date('H:i', strtotime($config->friday_start2)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-friday_end2">Hora de Finalización</label>
                            <input type="text" id="txt-friday_end2" class="form-control" value="<?php echo date('H:i', strtotime($config->friday_end2)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 mt-5">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <h5 class="bg-secondary p-2">Sábado</h5>
            <div class="row">
                <div class="col-12 text-end">
                    <?php
                    $label = '';
                ...
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-saturday_start1" class="form-control" value="<?php echo date('H:i', strtotime($config->saturday_start1)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-saturday_end1">Hora de Finalización</label>
                            <input type="text" id="txt-saturday_end1" class="form-control" value="<?php echo date('H:i', strtotime($config->saturday_end1)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-saturday_start2" class="form-control" value="<?php echo date('H:i', strtotime($config->saturday_start2)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-saturday_end2">Hora de Finalización</label>
                            <input type="text" id="txt-saturday_end2" class="form-control" value="<?php echo date('H:i', strtotime($config->saturday_end2)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 mt-5">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <h5 class="bg-secondary p-2">Domingo</h5>
            <div class="row">
                <div class="col-12 text-end">
                    <?php
                    $label = '';
                ...
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-sunday_start1" class="form-control" value="<?php echo date('H:i', strtotime($config->sunday_start1)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-sunday_end1">Hora de Finalización</label>
                            <input type="text" id="txt-sunday_end1" class="form-control" value="<?php echo date('H:i', strtotime($config->sunday_end1)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <div class="row">
                        <div class="col-6 mt-5">
                            ...
                            <input type="text" id="txt-sunday_start2" class="form-control" value="<?php echo date('H:i', strtotime($config->sunday_start2)); ?>" <?php echo $disabled; ?> />
                        </div>
                        <div class="col-6 mt-5">
                            <label for="txt-sunday_end2">Hora de Finalización</label>
                            <input type="text" id="txt-sunday_end2" class="form-control" value="<?php echo date('H:i', strtotime($config->sunday_end2)); ?>" <?php echo $disabled; ?> />
                        </div>
                    </div>
                </div>
                <div class="col-12 mt-5">
        ...
        $('#schedule-monday').on('click', function() {
            $.ajax({
                ...
                success: function(response) {
                    switch (response.error) {
                        case 0:
                            showAlert('success', 'Perfecto', 'Horarios seteados satisfactoriamente');
                            break
                        case 1:
                            showAlert('error', 'Lo Sentimos', 'Ha ocurrido un error');
                            break
